...
- Current state: enemy-owned worlds can now be assaulted into contested state, captured through deterministic takeover resolution, pacified back to full productivity, destroyed by costly strategic strikes, and defended against those strikes by ground-defense interception; command-collapse rules and fuller interruption logic are still missing.
...
| Victory resolution | Ascension victory, first deterministic military conquest victory, and strategic-destruction denial flows can all be completed from a fresh session under deterministic control; later military work must still add interruption rules and broader no-draw enforcement coverage | Military and victory, Progression and agents, Hardening and balance harness |
